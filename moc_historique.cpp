...
**
** Created: Sun Jul 11 14:21:19 2010
...
static const char qt_meta_stringdata_Historique[] = {
    "Historique\0\0afficher()\0"
};

const QMetaObject Historique::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Historique,
      qt_meta_data_Historique, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Historique::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Historique))
        return static_cast<void*>(const_cast< Historique*>(this));
